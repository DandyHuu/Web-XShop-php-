        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"> <?= ucwords($_SESSION['auth']['name']) ?></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                 <?= ucwords($_SESSION['auth']['name']) ?> - Web Developer
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          ...
          <p> <?= ucwords($_SESSION['auth']['name'])  ?></p>
          <!-- Status -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="">
          <a href="index.php"><i class="fa fa-link"></i> <span>Trang chủ Admin</span>
        ...
        <li class="">
          <a href="order-list.php"><i class="fa fa-link"></i> <span>Quản lí đơn hàng</span>
           
          </a>
        </li>
        <li class="">
          <a href="user-list.php"><i class="fa fa-link"></i> <span>Người dùng/Khách hàng</span>
          </a>
        </li>
      </ul>
      <!-- /.sidebar-menu -->
